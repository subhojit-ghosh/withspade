...
@section('content')
    ...
    <div class="max-w-xl mx-auto my-10" x-data="twoStep">
        ...
        <div class="flex flex-col w-full px-4 py-8 bg-white rounded-lg shadow sm:px-6 md:px-8 lg:px-10">
            ...
            <p class="text-center">Please confirm your account by entering the verification code from Google Authenticator
                app
            </p>
            <div class="mt-8">
                    ...
                    <div class="flex flex-col mb-2">
                        <div class="flex relative ">
                            <input type="text"
                                ...
                                placeholder="Verification code" x-model="secret" required />
                        </div>
                    </div>
    ...
    <script>
        document.addEventListener('alpine:init', () => {
            Alpine.data('twoStep', () => ({
                ...
                async submit() {
                    this.loading = true;
                    fetch("{{ route('login.verify_google2fa') }}", {
                            method: 'POST',
                            headers: {
